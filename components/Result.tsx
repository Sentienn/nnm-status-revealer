      ...
      <div className="relative z-10 w-full max-w-2xl text-center text-white">
        ...
        <div className="bg-white/20 border border-white/30 backdrop-blur-md px-6 py-8 md:px-12 md:py-10 rounded-2xl shadow-lg">
          ...
          {isLulus && (
            <a
              href="#"
              className="block w-4/5 max-w-sm mx-auto bg-[#BB001D] hover:bg-red-700 text-white 
                         px-6 py-2 sm:py-3 md:px-10 md:py-4 rounded-full 
                         text-sm sm:text-base md:text-lg font-semibold mb-4 text-center transition"
            >
              Masuk Grup
            </a>
          )}
          ...
          <button
            onClick={onBack}
            className="block w-4/5 max-w-sm mx-auto bg-white/85 border-2 border-[#BB001D] 
                       text-[#BB001D] hover:bg-[#BB001D] hover:text-white 
                       px-6 py-2 sm:py-3 md:px-10 md:py-4 rounded-full 
                       text-sm sm:text-base md:text-lg font-semibold text-center transition"
          >
            Kembali
          </button>
        </div>
